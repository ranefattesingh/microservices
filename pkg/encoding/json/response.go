...
import (
	...
	"github.com/ranefattesingh/microservices/pkg/errors"
)
...
type Responder interface {
	...
	Created(any) error
	NoContent() error
	BadRequest(error, ...errors.FieldError) error
...
func (r *Response) BadRequest(err error, fieldErrs ...errors.FieldError) error {
	r.Success = false
	r.Data = nil
